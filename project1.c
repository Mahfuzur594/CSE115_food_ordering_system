...
//use of recursion
int total_price(int quantity, int price){

    if(price == 0){
        return 0;
    }
    return quantity + total_price(quantity, (price-1)); 
}
...
int main()
{
    ...
    outfile = fopen("details.dat", "w");

    struct details input1 = {"maruf", 21, "mgh43$fj", "mbfgfh@gmail.com", "0193454545"};
    struct details input2 = {"rohan", 21, "mas43$fj", "mbigffah@gmail.com", "0193454545"};
    struct details input3 = {"dihan", 21, "dgh43$%f", "mbfgfh@gmail.com", "0193454545"};
    struct details input4 = {"raihan", 21, "mas43$j", "mbigffah@gmail.com", "0193454545"};
    // write struct to file
    fwrite(&input1, sizeof(struct details), 1, outfile);
    fwrite(&input2, sizeof(struct details), 1, outfile);
    fwrite(&input3, sizeof(struct details), 1, outfile);
    fwrite(&input4, sizeof(struct details), 1, outfile);
    if (fwrite != 0)
...
void cart()
{
    int totalP = total_price(m[1].quantity, m[1].price);
    printf("\n\n\n\n--------------Cart");
    printf("----------------");
    printf("\nYour Total Order");
    printf("Amount is %d\n", total);
